...
class MFA_source_separation(object):
    ...
    def freq_modulation(self, source_idx, label, encoded_img):
        ...
        min_value = torch.min(encoded_img)#minimun value of latent unit which use to deactivate neuron.
    ...
    def source_separation(self, input, phase, mean, std, filedir="../test_/result/", filename="test"):
        """
